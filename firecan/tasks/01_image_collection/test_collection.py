...
class TestImageRequest(unittest.TestCase):
    def test_response_ft(self):
        ...
        response = image_collection.request_image_page(
            img_type=test_img_type, date_str=test_date_str
        )
...
class TestImageScrape(unittest.TestCase):
    def test_image_scrape(self):
        ...
        final = image_collection.scrape_images(
            n=10, img_type=test_img_type, date_str=test_date_str
        )
